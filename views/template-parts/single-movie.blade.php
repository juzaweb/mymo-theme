<div class="container">
    ...
    <main id="main-contents" class="col-xs-12 col-sm-12 col-md-8">
                        ...
                        <div class="film-poster col-md-9">
                            ...
                            @if($player_id)
                                <div class="mymo-play-btn hidden-xs">
                                    <a href="" class="play-btn" title="@lang('theme::app.click_to_play')" data-toggle="tooltip" data-placement="bottom">@lang('theme::app.click_to_play')</a>
                                </div>
                            @endif
                                ...
                                @if($countries->isNotEmpty())
                                    <p class="actors">@lang('theme::app.countries'):
                                        @foreach($countries as $country)
                                            <a href="" title="{{ $country->name }}">{{ $country->name }}</a>
                                        @endforeach
                                    </p>
                                @endif
                            </div>
                            ...
                            <span class="mymo-server-name">
                                ...
                                <ul id="listsv-{{ $server->id }}" class="mymo-list-eps">
                                    @foreach($video_files as $file)
                                        <li class="mymo-episode mymo-episode-{{ $file->id }}"><a href="" title="{{ $file->label }}"><span class="mymo-info-{{ $file->id }} box-shadow mymo-btn" data-post-id="{{ $post->id }}" data-server="{{ $server->id }}" data-episode-slug="{{ $file->id }}" data-position="first" data-embed="0">{{ $file->label }}</span></a></li>
                                    @endforeach
                                </ul>
        ...
        <div class="the_tag_list">
            @foreach($tags as $tag)
                <a href="" title="{{ $tag->name }}" rel="tag">{{ $tag->name }}</a>
            @endforeach
        </div>
    </main>
