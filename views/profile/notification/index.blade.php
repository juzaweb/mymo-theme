                    ...
                    <div class="row">
                        <div class="col-xs-8 hidden-xs">
                            ...
                            <span>
                                ...
                                <a href="{{ route('profile') }}">{{ trans('theme::app.profile') }}</a> »
                ...
                <section>
                    ...
                    <table class="table w-100">
                        ...
                        @foreach($notifications as $index => $notification)
                            <tr>
                                <td>{{ $index + 1 }}</td>
                                <td><a href="{{ route('profile.notification.detail', [$notification->id]) }}" @if(empty($notification->read_at)) style="font-weight: bold" @endif>{{ $notification->data['subject'] }}</a></td>
